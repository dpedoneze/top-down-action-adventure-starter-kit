...
func test_activation_signal_value_normal():
	...
	watch_signals(switch_component)
	switch_component.is_activated = true
	assert_signal_emitted_with_parameters(switch_component, "activation_signal", [true])
...
func test_activation_signal_value_inversed():
	...
	watch_signals(switch_component)
	switch_component.is_activated = true
	assert_signal_emitted_with_parameters(switch_component, "activation_signal", [false])
